...
const NavBar = () => {
    ...
    const navItems = [
        ...
        { name: "About", icon: <FiPhone size={22} className="text-purple-400" />, link: "/about" },
    ];
        ...
        >
            <div className=" mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    {/* Left Section: Dark Mode Toggle, Title, Search Bar */}
                    <div className="flex items-center space-x-4">
                        ...
                        >
                            {isDarkMode ? <FiSun size={20} className="text-yellow-400" /> : <FiMoon size={20} className="text-gray-700" />}
                        </button>
                    ...
                    <div className="flex items-center space-x-4">
                        {user ? (
                            <div className="relative group">
                                ...
                                {/* Dropdown Menu */}
                                <div className="absolute left-0 mt-2 w-44 bg-white shadow-lg rounded-lg py-2 text-black opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-opacity duration-300">
                                    <button
                                        onClick={signOutUser}
            ...
            <div className={`md:hidden fixed top-16 right-0 h-[400px] w-[300px] flex flex-col items-center justify-center space-y-8 transition-transform transform ${isMenuOpen ? "translate-x-0 bg-gray-900 bg-opacity-95" : "translate-x-full"} duration-300`}
            >
                {navItems.map((item, index) => (
